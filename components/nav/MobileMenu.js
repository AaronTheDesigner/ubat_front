...
const MobileMenu = ({onClick}) => {
    ...
    return (
        <div className="flex z-50 flex-col bg-gray-500 h-screen items-center justify-center overflow-y-scroll gap-y-8" role="mobile menu" >
            {/* logo */}
            <div className="text-3xl" onClick={onClick}>
                <Link href="/#">LOGO</Link>
            </div>
            {/* menu */}
            <div className="list-none flex flex-col justify-center items-center gap-y-5 pb-3">
            ...
            {/* social items */}
            <div className="flex gap-x-4 opacity-75 pb-10">
                <Link href="#" class="p-2">
