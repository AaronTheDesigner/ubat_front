...
const MobileMenu = ({onClick}) => {
    ...
    return (
        <div className="flex z-50 flex-col bg-gray-500 h-screen items-center justify-center overflow-y-scroll gap-y-2" role="mobile menu" >
            {/* logo */}
            <div className="text-xl" onClick={onClick}>
                <Link href="/#">LOGO</Link>
            </div>
            {/* menu */}
            <div className="list-none flex h-3/5 flex-col justify-center items-center gap-y-5 text-base pb-3">
            ...
            {/* social items */}
            <div className="flex h-1/5 gap-x-4 opacity-75 pb-10">
                <Link href="#" class="p-2">
