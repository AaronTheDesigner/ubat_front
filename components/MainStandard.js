...
const MainStandard = () => {
    return (
        // Hero
        <div className="flex text-white relative mt-12 mb-20 lg:mt-28">
            <div className="flex flex-col z-10 gap-y-10 max-w-lg md:max-w-xl xl:max-w-2xl 2xl:max-w-4xl">
                <h1 className="equinox-bold text-5xl uppercase md:text-6xl 2xl:text-7xl">
                    <span className="text-teal">F</span>reelance <br /> <span className="text-orange">D</span>eveloper
                </h1>
            ...
            <div className='absolute w-full max-w-sm max-h-sm right-0 md:-top-20 2xl:max-w-1xl 2xl:max-h-1xl 2xl:right-12'>
                <BackgroundAnimation/>
            </div>
        </div>
    )
